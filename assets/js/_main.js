...
function (t, e) {
    ...
    if (u.stringify = u.stringify || u.encode, u.parse = u.parse || u.decode, void 0 !== d.init) throw new Error("History.js Core has already been loaded...");
    d.init = function (t) {
        return void 0 !== d.Adapter && (void 0 !== d.initCore && d.initCore(), void 0 !== d.initHtml4 && d.initHtml4(), !0)
    }, d.initCore = function (f) {
        if (void 0 !== d.initCore.initialized) return !1;
        if (d.initCore.initialized = !0, d.options = d.options || {}, d.options.hashChangeInterval = d.options.hashChangeInterval || 100, d.options.safariPollInterval = d.options.safariPollInterval || 500, d.options.doubleCheckInterval = d.options.doubleCheckInterval || 500, d.options.disableSuid = d.options.disableSuid || !1, d.options.storeInterval = d.options.storeInterval || 1e3, d.options.busyDelay = d.options.busyDelay || 250, d.options.debug = d.options.debug || !1, d.options.initialTitle = d.options.initialTitle || n.title, d.options.html4Mode = d.options.html4Mode || !1, d.options.delayInit = d.options.delayInit || !1, d.intervalList = [], d.clearAllIntervals = function () {
                ...
                var e = void 0 !== i && void 0 !== i.log && void 0 !== i.log.apply,
                    s = n.getElementById("log"),
                    o, r, a, l, h;
                for (e ? (o = (l = Array.prototype.slice.call(arguments)).shift(), void 0 !== i.debug ? i.debug.apply(i, [o, l]) : i.log.apply(i, [o, l])) : o = "\n" + t + "\n", r = 1, a = arguments.length; r < a; ++r) {
                    if ("object" == typeof (h = arguments[r]) && void 0 !== u) try {
                        h = u.stringify(h)
                    } catch (t) {}
                    o += "\n" + h + "\n"
                }
                return s ? (s.value += o + "\n-----\n", s.scrollTop = s.scrollHeight - s.clientHeight) : e || c(o), !0
                ...
                var i = t,
                    n = t.substring(0, 1);
                return e = void 0 === e || e, /[a-z]+\:\/\//.test(t) || (i = "/" === n ? d.getRootUrl() + t.replace(/^\/+/, "") : "#" === n ? d.getPageUrl().replace(/#.*/, "") + t : "?" === n ? d.getPageUrl().replace(/[\?#].*/, "") + t : e ? d.getBaseUrl() + t.replace(/^(\.\/)+/, "") : d.getBasePageUrl() + t.replace(/^(\.\/)+/, "")), i.replace(/\#$/, "")
            }, d.getShortUrl = function (t) {
                var e = t,
                    i = d.getBaseUrl(),
                    n = d.getRootUrl();
                return d.emulated.pushState && (e = e.replace(i, "")), e = e.replace(n, "/"), d.isTraditionalAnchor(e) && (e = "./" + e), e = e.replace(/^(\.\/)+/g, "./").replace(/\#$/, "")
                ...
                return !i && e && (i = d.createStateObject()), t && ((i = d.cloneObject(i)).url = i.cleanUrl || i.url), i
            }, d.getIdByState = function (t) {
                var e = d.extractId(t.url),
                    i;
                if (!e)
                    if (i = d.getStateString(t), void 0 !== d.stateToId[i]) e = d.stateToId[i];
                    else if (void 0 !== d.store.stateToId[i]) e = d.store.stateToId[i];
                else {
                    for (; e = (new Date).getTime() + String(Math.random()).replace(/\D/g, ""), void 0 !== d.idToState[e] || void 0 !== d.store.idToState[e];);
                    d.stateToId[i] = e, d.idToState[e] = t
                }
                return e
            }, d.normalizeState = function (t) {
                var e, i;
                return t && "object" == typeof t || (t = {}), void 0 !== t.normalized ? t : (t.data && "object" == typeof t.data || (t.data = {}), (e = {}).normalized = !0, e.title = t.title || "", e.url = d.getFullUrl(t.url ? t.url : d.getLocationHref()), e.hash = d.getShortUrl(e.url), e.data = d.cloneObject(t.data), e.id = d.getIdByState(e), e.cleanUrl = e.url.replace(/\??\&_suid.*/, ""), e.url = e.cleanUrl, i = !d.isEmptyObject(e.data), (e.title || i) && !0 !== d.options.disableSuid && (e.hash = d.getShortUrl(e.url).replace(/\??\&_suid.*/, ""), /\?/.test(e.hash) || (e.hash += "?"), e.hash += "&_suid=" + e.id), e.hashedUrl = d.getFullUrl(e.hash), (d.emulated.pushState || d.bugs.safariPoll) && d.hasUrlDuplicate(e) && (e.url = e.hashedUrl), e)
                ...
                var i = null,
                    n, s;
                return e = e || !1, (n = d.extractId(t)) && (i = d.getStateById(n)), i || (s = d.getFullUrl(t), (n = d.getIdByUrl(s) || !1) && (i = d.getStateById(n)), !i && e && !d.isTraditionalAnchor(t) && (i = d.createStateObject(null, null, s))), i
                ...
                var e = !1,
                    i, n, s;
                return d.savedStates.length && (e = (i = t.id) === (s = (n = d.getLastSavedState()).id)), e
                ...
                return !1 !== e && d.busy() ? (d.pushQueue({
                    ...
                    args: arguments,
                    queue: e
                }), !1) : (d.busy(!0), (i = d.extractState(t, !0)) && !d.emulated.pushState ? d.pushState(i.data, i.title, i.url, !1) : d.getHash() !== t && (d.bugs.setHash ? (s = d.getPageUrl(), d.pushState(null, null, s + "#" + t, !1)) : n.location.hash = t), d)
            }, d.escapeHash = function (e) {
                var i = d.normalizeHash(e);
                return i = t.encodeURIComponent(i), d.bugs.hashEscape || (i = i.replace(/\%21/g, "!").replace(/\%26/g, "&").replace(/\%3D/g, "=").replace(/\%3F/g, "?")), i
                ...
                if (void 0 !== t ? d.busy.flag = t : void 0 === d.busy.flag && (d.busy.flag = !1), !d.busy.flag) {
                    a(d.busy.timeout);
                    var e = function () {
                        var t, i, n;
                        if (!d.busy.flag)
                            for (t = d.queues.length - 1; t >= 0; --t) 0 !== (i = d.queues[t]).length && (n = i.shift(), d.fireQueueItem(n), d.busy.timeout = r(e, d.options.busyDelay))
                    };
                ...
                return "function" == typeof t && (t = {
                    callback: t
                }), void 0 !== e && (t.queue = e), d.busy() ? d.pushQueue(t) : d.fireQueueItem(t), d
                ...
                var e = d.extractState(d.getLocationHref()),
                    i;
                if (!d.isLastSavedState(e)) return (i = e) || (i = d.createStateObject()), d.Adapter.trigger(t, "popstate"), d
            }, d.back = function (t) {
                ...
                if (t > 0)
                    ...
                    for (i = -1; i >= t; --i) d.back(e)
                }
                return d
            }, d.emulated.pushState) {
            var g = function () {};
            d.pushState = d.pushState || g, d.replaceState = d.replaceState || g
        } else d.onPopState = function (e, i) {
            var n = !1,
                s = !1,
                o, r;
            return d.doubleCheckComplete(), (o = d.getHash()) ? ((r = d.extractState(o || d.getLocationHref(), !0)) ? d.replaceState(r.data, r.title, r.url, !1) : (d.Adapter.trigger(t, "anchorchange"), d.busy(!1)), d.expectedStateId = !1, !1) : ((s = (n = d.Adapter.extractEventData("state", e, i) || !1) ? d.getStateById(n) : d.expectedStateId ? d.getStateById(d.expectedStateId) : d.extractState(d.getLocationHref())) || (s = d.createStateObject(null, null, d.getLocationHref())), d.expectedStateId = !1, d.isLastSavedState(s) ? (d.busy(!1), !1) : (d.storeState(s), d.saveState(s), d.setTitle(s), d.Adapter.trigger(t, "statechange"), d.busy(!1), !0))
        }, d.Adapter.bind(t, "popstate", d.onPopState), d.pushState = function (e, i, n, s) {
            ...
            if (!1 !== s && d.busy()) return d.pushQueue({
                scope: d,
            ...
            return d.isLastSavedState(o) ? d.busy(!1) : (d.storeState(o), d.expectedStateId = o.id, p.pushState(o.id, o.title, o.url), d.Adapter.trigger(t, "popstate")), !0
            ...
            d.busy(!0);
            var o = d.createStateObject(e, i, n);
            return d.isLastSavedState(o) ? d.busy(!1) : (d.storeState(o), d.expectedStateId = o.id, p.replaceState(o.id, o.title, o.url), d.Adapter.trigger(t, "popstate")), !0
        };
        if (o) {
            try {
        ...
        d.Adapter.bind(t, "unload", d.clearAllIntervals), d.saveState(d.storeState(d.extractState(d.getLocationHref(), !0))), o && (d.onUnload = function () {
            var t, e, i;
            try {
            ...
            d.store = t, d.normalizeStore(), i = u.stringify(t);
            try {
        ...
        }, d.intervalList.push(l(d.onUnload, d.options.storeInterval)), d.Adapter.bind(t, "beforeunload", d.onUnload), d.Adapter.bind(t, "unload", d.onUnload)), d.emulated.pushState || (d.bugs.safariPoll && d.intervalList.push(l(d.safariStatePoll, d.options.safariPollInterval)), "Apple Computer, Inc." !== s.vendor && "Mozilla" !== (s.appCodeName || "") || (d.Adapter.bind(t, "hashchange", function () {
...
function (t, e) {
    ...
    function i(i, o, a) {
        ...
        function h(t, e) {
            ...
            var e;
            return "string" == typeof t ? l(this, t, s.call(arguments, 1)) : (h(this, t), this)
        }, n(a))
    }
    ...
    function o(e) {
        if (s(), "string" == typeof e && (e = document.querySelector(e)), e && "object" == typeof e && e.nodeType) {
            ...
            var g = a.paddingLeft + a.paddingRight,
                ...
                b = u && r,
                x = t(o.width);
            !1 !== x && (a.width = x + (b ? 0 : g + _));
            var C = t(o.height);
            return !1 !== C && (a.height = C + (b ? 0 : m + w)), a.innerWidth = a.width - (g + _), a.innerHeight = a.height - (m + w), a.outerWidth = a.width + v, a.outerHeight = a.height + y, a
        }
    }
...
function (t, e) {
    ...
    return n._resetLayout = function () {
        ...
        var e = t.size.outerWidth % this.columnWidth,
            i, n = Math[e && 1 > e ? "round" : "ceil"](t.size.outerWidth / this.columnWidth);
        ...
        var i = e(t),
            ...
            s, o = this._getOption("originLeft") ? n.left : n.right,
            r = o + i.outerWidth,
            a = Math.floor(o / this.columnWidth);
        a = Math.max(0, a);
        var l = Math.floor(r / this.columnWidth);
        l -= r % this.columnWidth ? 0 : 1, l = Math.min(this.cols - 1, l);
        for (var h, u = (this._getOption("originTop") ? n.top : n.bottom) + i.outerHeight, c = a; l >= c; c++) this.colYs[c] = Math.max(u, this.colYs[c])
...
function (t, e, i, n) {
    ...
    function s(e, i) {
        ...
        }), this.settings = t.extend({}, a, i, n), this.settings.viewportFill = Math.max(Math.min(parseFloat(this.settings.viewportFill), 1), 0), this.settings.stackIndex < this.settings.stackIndexDelta && (settings.stackIndexDelta = settings.stackIndex), this._name = r, this.init()
    }
    var o = t(e),
        r = (t(i), "fluidbox"),
        a = {
    ...
    var u, c = function () {
        ...
        d = {
            ...
            prepareFb: function () {
                var e = this,
                    i = t(this.element);
                i.trigger("thumbloaddone.fluidbox"), d.measure.fbElements.call(this), e.bindEvents(), i.addClass("fluidbox--ready"), e.bindListeners(), i.trigger("ready.fluidbox")
            },
            measure: {
                viewport: function () {
                    l.viewport = {
    ...
    t.extend(s.prototype, {
        init: function () {
            var e = this,
                i = t(this.element),
                n = i.find("img").first();
            if (d.measure.viewport(), (!e.instanceData || !e.instanceData.initialized) && i.is("a") && 1 === i.children().length && (i.children().is("img") || i.children().is("picture") && 1 === i.find("img").length) && "none" !== i.css("display") && "none" !== i.children().css("display") && "none" !== i.parents().css("display")) {
                i.removeClass("fluidbox--destroyed"), e.instanceData = {}, e.instanceData.initialized = !0, e.instanceData.originalNode = i.html(), h += 1, e.instanceData.id = h, i.addClass("fluidbox__instance-" + h), i.addClass("fluidbox--initialized"), d.dom.call(e), i.trigger("init.fluidbox");
                var s = new Image;
                n.width() > 0 && n.height() > 0 ? d.prepareFb.call(e) : (s.onload = function () {
                    d.prepareFb.call(e)
                }, s.onerror = function () {
        ...
        open: function () {
            var e = this,
                ...
                s = i.find(".fluidbox__ghost"),
                o = i.find(".fluidbox__wrap");
            e.instanceData.state = 1, s.off(c), t(".fluidbox--opened").fluidbox("close");
            var r = t("<div />", {
                ...
                a;
            if (o.append(r), i.removeClass("fluidbox--closed").addClass("fluidbox--loading"), d.checkURL(n.attr("src"))) return e.close(), !1;
            s.css({
                "background-image": "url(" + d.formatURL(n.attr("src")) + ")",
                opacity: 1
            }), d.measure.fbElements.call(e), e.settings.immediateOpen ? (i.addClass("fluidbox--opened fluidbox--loaded").find(".fluidbox__wrap").css({
                ...
                if (i.trigger("imageloaddone.fluidbox"), 1 === e.instanceData.state) {
                    if (e.instanceData.thumb.natW = a.naturalWidth, e.instanceData.thumb.natH = a.naturalHeight, i.removeClass("fluidbox--loading"), d.checkURL(a.src)) return e.close({
                        error: !0
                    }), !1;
                    s.css({
                        "background-image": "url(" + d.formatURL(a.src) + ")"
                    }), e.compute()
                }
            }, a.onerror = function () {
                e.close({
                    error: !0
                }), i.trigger("imageloadfail.fluidbox"), i.trigger("delayedloadfail.fluidbox")
            }, a.src = i.attr("href")) : ((a = new Image).onload = function () {
                return i.trigger("imageloaddone.fluidbox"), i.removeClass("fluidbox--loading").addClass("fluidbox--opened fluidbox--loaded").find(".fluidbox__wrap").css({
                    zIndex: e.settings.stackIndex + e.settings.stackIndexDelta
                }), i.trigger("openstart.fluidbox"), d.checkURL(a.src) ? (e.close({
                    error: !0
                }), !1) : (s.css({
                    "background-image": "url(" + d.formatURL(a.src) + ")"
                }), e.instanceData.thumb.natW = a.naturalWidth, e.instanceData.thumb.natH = a.naturalHeight, e.compute(), n.css({
                    opacity: 0
                }), t(".fluidbox__overlay").css({
                    opacity: 1
                }), void s.one(c, function () {
                    i.trigger("openend.fluidbox")
                }))
            }, a.onerror = function () {
                e.close({
        ...
        compute: function () {
            var e = this,
                ...
                f, g, m, v, y;
            e.settings.maxWidth > 0 ? h = (a = e.settings.maxWidth) / d : e.settings.maxHeight > 0 && (a = (h = e.settings.maxHeight) * d), p > d ? (v = a * (c * (m = (f = h < l.viewport.h ? h : l.viewport.h * e.settings.viewportFill) / c) / h) / u, y = m) : (m = h * (u * (v = (g = a < l.viewport.w ? a : l.viewport.w * e.settings.viewportFill) / u) / a) / c, y = v), e.settings.maxWidth && e.settings.maxHeight && console.warn("Fluidbox: Both maxHeight and maxWidth are specified. You can only specify one. If both are specified, only the maxWidth property will be respected. This will not generate any error, but may cause unexpected sizing behavior.");
            var _ = o.scrollTop() - n.offset().top + c * (y - 1) * .5 + .5 * (o.height() - c * y),
                w = u * (y - 1) * .5 + .5 * (o.width() - u * y) - n.offset().left,
                b = parseInt(100 * v) / 100 + "," + parseInt(100 * m) / 100;
            s.css({
                transform: "translate(" + parseInt(100 * w) / 100 + "px," + parseInt(100 * _) / 100 + "px) scale(" + b + ")",
        ...
        close: function (e) {
            ...
            return null !== i.instanceData.state && typeof i.instanceData.state != typeof n && 0 !== i.instanceData.state && (i.instanceData.state = 0, s.trigger("closestart.fluidbox"), s.removeClass(function (t, e) {
                return (e.match(/(^|\s)fluidbox--(opened|loaded|loading)+/g) || []).join(" ")
            }).addClass("fluidbox--closed"), r.css({
                transform: "translate(0,0) scale(1,1)",
                top: o.offset().top - a.offset().top + parseInt(o.css("borderTopWidth")) + parseInt(o.css("paddingTop")),
                left: o.offset().left - a.offset().left + parseInt(o.css("borderLeftWidth")) + parseInt(o.css("paddingLeft"))
            }), s.find(".fluidbox__loader").css({
                transform: "none"
            }), r.one(c, function () {
                r.css({
                    opacity: 0
            ...
            }), h.error && r.trigger("transitionend"), void l.css({
                opacity: 0
            }))
        },
        bindEvents: function () {
        ...
        bindListeners: function () {
            var e = this,
                i = t(this.element),
                n = function () {
                    d.measure.viewport(), d.measure.fbElements.call(e), i.hasClass("fluidbox--opened") && e.compute()
                };
            t.isFunction(t.throttle) ? o.on("resize.fluidbox" + e.instanceData.id, t.throttle(e.settings.resizeThrottle, n)) : o.on("resize.fluidbox" + e.instanceData.id, n), i.on("reposition.fluidbox", function () {
                e.reposition()
        ...
        unbind: function () {
            t(this.element).off("click.fluidbox reposition.fluidbox recompute.fluidbox compute.fluidbox destroy.fluidbox close.fluidbox"), o.off("resize.fluidbox" + this.instanceData.id)
        },
        reposition: function () {
        ...
        destroy: function () {
            ...
            this.unbind(), t.data(this.element, "plugin_" + r, null), t(this.element).removeClass(function (t, e) {
        ...
        return e === n || "object" == typeof e ? this.each(function () {
            ...
            n instanceof s && "function" == typeof n[e] ? o = n[e].apply(n, Array.prototype.slice.call(i, 1)) : console.warn('Fluidbox: The method "' + e + '" used is not defined in Fluidbox. Please make sure you are calling the correct public method.')
        }), o !== n ? o : this) : this
    }
...
function (t, e, i, n) {
    ...
    s.Defaults = {
        ...
        3 !== e.which && (t.support.transform ? n = {
                ...
                y: n.top
            }), this.is("animating") && (t.support.transform ? this.animate(n.x) : this.$stage.stop(), this.invalidate("position")), this.$element.toggleClass(this.options.grabClass, "mousedown" === e.type), this.speed(0), this._drag.time = (new Date).getTime(), this._drag.target = t(e.target),
            this._drag.stage.start = n, this._drag.stage.current = n, this._drag.pointer = this.pointer(e), t(i).on("mouseup.owl.core touchend.owl.core", t.proxy(this.onDragEnd, this)), t(i).one("mousemove.owl.core touchmove.owl.core", t.proxy(function (e) {
...
function (t, e, i, n) {
    ...
    s.Defaults = {
        ...
        var i, n, s = t(e.target).closest("." + this._core.settings.itemClass),
...
function (t, e, i, n) {
    ...
    (function () {
        return !!s("transition")
    })() && (t.support.transition = new String(o("transition")), t.support.transition.end = l.transition.end[t.support.transition]), d() && (t.support.animation = new String(o("animation")), t.support.animation.end = l.animation.end[t.support.animation]), h() && (t.support.transform = new String(o("transform")), t.support.transform3d = u())
}(window.Zepto || window.jQuery, window, document),
function () {
    "use strict";
...
function () {
    ...
    function t(t) {
        return function (i, n) {
            var s = [],
                o = i;
            return t.isFunction(i) && ((o = t.extend({}, n)).handler = i), this.each(function () {
                var i = t.extend({}, o, {
                    element: this
                });
                "string" == typeof i.context && (i.context = t(this).closest(i.context)[0]), s.push(new e(i))
            }), s
        }
    }
...
function (t) {
    ...
    function e() {
        t(".page__content").find(".hero__image").imagesLoaded({
            background: !0
        }, function () {
            t(".portfolio-wrap").imagesLoaded(function () {
                t(".portfolio-wrap").masonry({
                    itemSelector: ".portfolio-item",
                    transitionDuration: 0
                })
            }), t(".blog-wrap").imagesLoaded(function () {
                t(".blog-wrap").masonry({
                    itemSelector: ".blog-post",
                    transitionDuration: 0
                })
            }), t("body").removeClass("loading"), t("body").removeClass("menu--open")
        }), t(".active-link").removeClass("active-link"), t('a[href="' + i + '"]').addClass("active-link"), Waypoint.destroyAll();
        var e = 0;
        t(".gallery").each(function () {
            ...
            i.append('<div class="gallery__wrap"></div>'), i.children("img").each(function () {
                t(this).appendTo("#" + n + " .gallery__wrap")
            }), i.find(".gallery__wrap img").each(function () {
                var e = t(this).attr("src");
                t(this).wrapAll('<div class="gallery__item"><a href="' + e + '" class="gallery__item__link"></div></div>').appendTo()
            }), i.imagesLoaded(function () {
                if ("1" === s) {
                    i.addClass("gallery--carousel"), i.children(".gallery__wrap").addClass("owl-carousel"), i.children(".gallery__wrap").owlCarousel({
                        items: 1,
                        loop: !0,
                        mouseDrag: !1,
                        touchDrag: !0,
                    ...
                    var t = new Waypoint({
                            ...
                            handler: function (t) {
                                "down" === t && i.children(".gallery__wrap").trigger("stop.owl.autoplay"), "up" === t && i.children(".gallery__wrap").trigger("play.owl.autoplay")
                            },
                            offset: "-100%"
                        }),
                        e = new Waypoint({
                            element: document.getElementById(n),
                            handler: function (t) {
                                "down" === t && i.children(".gallery__wrap").trigger("play.owl.autoplay"), "up" === t && i.children(".gallery__wrap").trigger("stop.owl.autoplay")
                            },
                            offset: "100%"
                        })
                } else i.addClass("gallery--grid"), i.children(".gallery__wrap").masonry({
        ...
        }), t(".single p > img").each(function () {
            var e = t(this).parent("p");
            t(this).insertAfter(e), t(this).wrapAll('<div class="image-wrap"></div>'), e.remove()
        }), t(".single iframe").each(function () {
            if (t(this).attr("src").indexOf("youtube") >= 0 || t(this).attr("src").indexOf("vimeo") >= 0) {
                var e = t(this).attr("width"),
                    i, n = t(this).attr("height") / e * 100;
                t(this).wrapAll('<div class="video-wrap"><div class="video" style="padding-bottom:' + n + '%;"></div></div>')
            }
        })
    }
    var i = t("body").attr("data-page-url"),
        n = document.title,
        s = window.History;
    s.Adapter.bind(window, "statechange", function () {
        var o = s.getState();
        t("body").addClass("loading"), t(".page-loader").load(o.hash + " .page__content", function () {
            t("body, html").animate({
                scrollTop: 0
            }, 300);
            var s = 400;
            setTimeout(function () {
                t(".page .page__content").remove(), t(".page-loader .page__content").appendTo(".page"), t("body").attr("data-page-url", window.location.pathname), i = t("body").attr("data-page-url"), n = t(".page__content").attr("data-page-title"), document.title = n, e()
            }, 400)
        })
    }), t("body").hasClass("ajax-loading") && t(document).on("click", "a", function (e) {
        e.preventDefault();
        var o = t(this).attr("href");
        t(this).hasClass("js-no-ajax") ? window.location = o : t(this).hasClass("js-contact") ? t(".modal--contact").addClass("modal--on") : t(this).hasClass("js-signup") ? t(".modal--signup").addClass("modal--on") : t(this).is(".gallery__item__link") || (o.indexOf("http") >= 0 ? window.open(o, "_blank") : (i = o, s.pushState(null, n, o)))
    }), t(document).on("click", ".js-contact", function (e) {
        e.preventDefault(), t(".modal--contact").addClass("modal--on")
    }), t(document).on("click", ".js-signup", function (e) {
        e.preventDefault(), t(".modal--signup").addClass("modal--on")
    }), e(), t(document).on("click", ".js-menu-toggle", function () {
        t("body").hasClass("menu--open") ? t("body").removeClass("menu--open") : t("body").addClass("menu--open")
    }), t(document).on("click", ".menu__list__item__link", function () {
        t(".menu").hasClass("menu--open") && t(".menu").removeClass("menu--open")
    }), t(document).on("click", ".post", function () {
        var e = t(this).find(".post__title a").attr("href");
        t("body").hasClass("ajax-loading") ? (i = e, s.pushState(null, n, e)) : window.location = e
    }), t(document).on("submit", "#contact-form", function (e) {
        t(".contact-form__item--error").removeClass("contact-form__item--error");
        var i = t('.contact-form__input[name="email"]'),
            n = t('.contact-form__input[name="name"]'),
            s = t('.contact-form__textarea[name="message"]'),
            o = t(".contact-form__gotcha");
        "" === i.val() && i.closest(".contact-form__item").addClass("contact-form__item--error"), "" === n.val() && n.closest(".contact-form__item").addClass("contact-form__item--error"), "" === s.val() && s.closest(".contact-form__item").addClass("contact-form__item--error"), "" !== i.val() && "" !== n.val() && "" !== s.val() && 0 === o.val().length || e.preventDefault()
    })
}(jQuery);